                    ...
                    <form class="p-4 md:p-5" method="POST" action="{{url('/admin/create/level')}}">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input type="text" name="title" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Level name" required="">
                            </div>
                        </div>
            ...
            @foreach($level as $levels)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap flex">
                        <button data-modal-target="edit-modal{{$levels->id}}" data-modal-toggle="edit-modal{{$levels->id}}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center " type="button">
                            Edit
                        </button>
                        <!-- Main modal -->
                                ...
                                <div class="relative bg-white rounded-lg shadow ">
                                    ...
                                    <form class="p-4 md:p-5" method="POST" action="/admin/update/level/{{$levels->id}}">
                                        ...
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
                                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
                                                <input type="text" name="title" id="name" value="{{$levels->name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Type product name" required="">
                                            </div>
                                        </div>
                                        <button type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                                            Save
