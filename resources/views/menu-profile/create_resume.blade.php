        ...
        <div>
                            ...
                            <div class=" ">
                                <div class="w-full max-w-3xl mx-auto p-8">
                                    <div class="  p-8 rounded-lg   ">
                                            ...
                                            <div class=" gap-4 mt-10">
                                                <div>
                                                    ...
                                                    <input type="text" id="first_name"
                                                           class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700  dark:border-none">
                                                </div>
                                                <div>
                                        ...
                                        <div>
                                            <div class="mt-4">
                                                <label for="card_number" class="block text-gray-700 dark:text-white mb-1">DATE
                                                    OF BIRTH</label>
                        ...
                        <div class="rounded-lg border bg-gray px-4 pt-8 pb-10 shadow-lg">
                            <div class="w-full max-w-3xl mx-auto p-8">
                                <div class="  p-8 rounded-lg   ">
                                    ...
                                    <div class="w-full max-w-3xl mx-auto ">
                                        <div class="bg-gray-100  p-8 rounded-lg shadow-md border dark:border-gray-700">
            ...
            <div class="p-4   ">
                <details class="mb-2">
                    ...
                    <div>
                        <div class="mt-4">
                            <label for="card_number" class="block text-gray-700 dark:text-white mb-1">Start</label>
                            <input type="date" name="date" id="date"
                                   class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                    </div>
                    <div>
                        <div class="mt-4">
                            <label for="card_number" class="block text-gray-700 dark:text-white mb-1">End</label>
                            <input type="date" name="date" id="date"
                                   class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
