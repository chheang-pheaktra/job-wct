        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
           <div>
               <a href="{{'/'}}" class="flex items-center space-x-3 rtl:space-x-reverse">
                   <img src="{{asset('asset/logo.jpg')}}" class="h-8" alt="career logo" />
                   <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">CareerQuest</span>
                    ...
                    @if (Route::has('login'))
                        @auth
                            <div class="flex items-center justify-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                                <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0  focus:ring-gray-300 " id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                                    <span class="sr-only">Open user menu</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size- w-8 h-8 rounded-full text-black bg-white p-1">
                                ...
                                <div class="z-50 hidden my-4 text-base list-none bg-blue-900 divide-y divide-gray-100 rounded-lg shadow " id="user-dropdown">
                                    ...
                                    <ul class="py-2" aria-labelledby="user-menu-button">
                                        ...
                                        <li>
                                            <a href="{{'/setting'}}" class="block px-4 py-2 text-sm text-white hover:bg-gray-100 hover:text-gray-500">Settings</a>
                                        </li>
                                        <li>
                    ...
                    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                        <ul class="flex text-white flex-col font-medium p-4 md:p-0 mt-4  rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 " >
                            <li class="border-b border-t lg:border-none md:border-none  ">
                                <a href="{{'/'}}" class="block py-2 px-3 text-white rounded hover:bg-yellow-600 md:hover:bg-transparent md:hover:text-yellow-400 md:p-0 text-white " >Home</a>
                            </li>
                            ...
                            <li class="border-b lg:border-none md:border-none">
                                <a href="{{'/job'}}" class="block py-2 px-3 text-white rounded hover:bg-yellow-100 md:hover:bg-transparent md:hover:text-yellow-400 md:p-0">Jobs</a>
                            </li>
                        </ul>
                    </div>
            </div>
