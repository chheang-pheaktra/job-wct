...
@section('contents')
        ...
        <nav class="flex mb-5 mt-16" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                <li class="inline-flex items-center">
                    <a href="{{url('/job')}}" class="text-gray-700 hover:text-gray-900 inline-flex items-center">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">{{$level->name}}</a>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    @else
        <section class="mt-10 mx-auto w-full max-w-screen-xl grid grid-cols-1 gap-6 text-black md:grid-cols-3 ">
            @php
                $filteredJobs = $jobs->where('level_id', $level->id);
            @endphp
